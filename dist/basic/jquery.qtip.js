 ...
 *
 * Date: Sun Feb 6 2022 03:22 GMT+0000+0000
 * Plugins: None
 * Styles: core
 */
...
PROTOTYPE.destroy = function(immediate) {
	...
	if((immediate !== TRUE || this.triggering === 'hide') && this.rendered) {
		this.tooltip.one('tooltiphidden', process.bind(this));
...
PROTOTYPE._createTitle = function()
{
	...
	.on('mousedown keydown mouseup keyup mouseout', '.qtip-close', function(event) {
		$(this).toggleClass('ui-state-active ui-state-focus', event.type.slice(-4) === 'down');
	})
